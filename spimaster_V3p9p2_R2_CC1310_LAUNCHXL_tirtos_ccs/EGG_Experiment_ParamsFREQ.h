...
#define PING_PERIOD_MIN 1          // period to transmit during sleep in minutes, integer, default=5
...
const uint64_t NUMBER_OF_SAMPLES_ARRAY[]    = {18750,   18750,  18750,  18750,  18750  };
const uint64_t TRANSMIT_FREQ_ARRAY[]        = {1,       2,      4,      8,      16  };
const uint64_t SLEEP_TIME_MIN_ARRAY[]       = {2,       2,      2,      2,      2   };
